...
public class CustomerDaoJpaImpl implements CustomerDao {
    ...
    public List<Customer> getByName(String name) {
        return (List<Customer>) em.createQuery("select customer from Customer as customer where customer.companyName=:companyName").setParameter("companyName", name).getResultList();
    }
