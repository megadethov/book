 ...
 * generated in the ua.mega.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://services.mega.ua/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://services.mega.ua/", "getEmployeeByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ua.mega.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.mega.ua/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.mega.ua/", name = "getEmployeeByIdResponse")
