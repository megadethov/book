 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://services.mega.ua/", wsdlLocation = "http://localhost:8080/any/name/you/like/employeeservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://services.mega.ua/", "EmployeeServiceImplService");
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://services.mega.ua/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class);
    }
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.mega.ua/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class, features);
    }
