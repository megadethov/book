...
-- for lynda.com course SQLite 3 With PHP Essential Training
-- version 1.2 2010-07-11
...
CREATE TABLE City (
  ...
  CountryCode VARCHAR(125) NOT NULL DEFAULT '',
  District VARCHAR(125) NOT NULL DEFAULT '',
...
CREATE TABLE Country (
  ...
  Name VARCHAR(125) NOT NULL default '',
  Continent VARCHAR(125) NOT NULL default 'Asia',
  ...
  LocalName VARCHAR(125) NOT NULL default '',
  GovernmentForm VARCHAR(125) NOT NULL default '',
  HeadOfState VARCHAR(125) default NULL,
  Capital INTEGER default NULL,
  Code2 VARCHAR(125) NOT NULL default ''
);
