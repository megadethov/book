 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://www.mega.ua/urm", wsdlLocation = "http://localhost:8080/testapp/users.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://www.mega.ua/urm", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/testapp/users.wsdl");
    ...
    public UserService getUserServiceSoap11() {
        return super.getPort(new QName("http://www.mega.ua/urm", "UserServiceSoap11"), UserService.class);
    }
    ...
    public UserService getUserServiceSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.mega.ua/urm", "UserServiceSoap11"), UserService.class, features);
    }
